...
- In the terminal, you can see the **task names** and the **BT programs** generated by BtBot, as well as the comparison results between BtBot and BTGenBot in RQ2 (Table 2.). For example, *MCTS_task1* task is *to move to positions 1, 2, 4, and 5*. Generate a BT program as shown in the figure.
